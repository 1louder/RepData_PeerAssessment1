...
plot(unique(wdayInt$interval), v, type="l", xlab="Interval", ylab="Average Steps", main="Average Steps by Interval")
...
plot(unique(wendInt$interval), v, type="l", xlab="Interval", ylab="Average Steps", main="Average Steps by Interval")
